...
def run_test_count_items_bigger_than():
    ...
    # Test 9:
    sequence = [234, 124, 900, 704, -101, 402]
    threshold = 253
    expected = 3
    actual = count_items_bigger_than(sequence, threshold)
    print()
    ...
    # Test 10:
    sequence = [0.23, 0, -0.01, 0.009, 0.100000000001, 402]
    threshold = 0.01
    expected = 3
    actual = count_items_bigger_than(sequence, threshold)
    print()
...
def run_test_sum_first_n():
    ...
    # Test 8:
    expected = 12
    actual = sum_first_n([1, 2, 3, -4, 5, 6, 7, -8], 8)
    print()
    print('Test 8 expected:', expected)
    print('       actual:  ', actual)
    ...
    # Test 9:
    expected = 58
    actual = sum_first_n([51, -25, 32, 5, 6, 7, 8], 3)
    print()
    print('Test 9 expected:', expected)
    print('       actual:  ', actual)
